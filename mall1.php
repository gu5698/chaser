...
?>
                    <div class="mall_page">
                        ...
                        <div class="mall_box col-md-2 col-8">
                            ...
                            <div class="button">
                                <a href="<?php echo "cartAdd.php?psn=".$prodrow->product_id."&pimage=$prodrow->product_image"."&pname=$prodrow->product_name"."&price=$prodrow->product_price" ?>"><span><h3 class="buy">直接購買</h3><div class="triangle"></div></span></a>
                                <span class="addCart" id="P<?php echo $prodrow->product_id ?>">
                                    <h3>加入購物車</h3>
