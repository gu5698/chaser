 ...
 <div id="fullscreen">
        ...
        <div class="content">
            <div class="left_part">
                <div class="item_wrap">
                    ...
                    <div class="item item02">
                        ...
                        <div id="chartgroup02" class="item_content_wrap">
            ...
            <div class="mid_part">
                <div class="tech_circle_wrap">
                    ...
                    <div class="cuProduct" id="cuProduct">
                        <img src="images/customize/glasses/circle-black-scan.gif" alt="" id="cuShow">
            ...
            <div class="right_part">
                <div class="name_wrap">
                    <p class="name fz-5">科技眼鏡</p>
                    <p class="price fz-5">8,600 USD</p>
                ...
                <div class="cu_chart">
                    ...
                    <input type="hidden" id="def" class="txt" name="" value="6" />
                    <input type="hidden" id="dex" class="txt" name="" value="6" />
                    <input type="hidden" id="dur" class="txt" name="" value="7" />
                    <input type="hidden" id="hide" class="txt" name="" value="8" />
                </div>
            </div>
...
<script src="js/cuGlasses.js"></script>
<script src="js/chartChange_glasses.js"></script>
