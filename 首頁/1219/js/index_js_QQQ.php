<?php
    try {
        ...
        $missions = $pdostatement -> fetchAll(PDO::FETCH_ASSOC);
...
<script>
    ...
    function init(){
        ...
        <?php
            ...
            function missionImg() {
                global $missions_i, $missions;
                $img = $missions[$missions_i]['img'];
                echo $img;
                $missions_i ++;
            }
            // missionImg();
        ...
        <?php
        for($missions_j=0; $missions_j<$missionsLen; $missions_j++){
        ?>
                
        // for(let i=0; i< <?php echo $missionsLen ?>; i++){
            // console.log(i);
            missionGroup.innerHTML += `
            <div class="mission mission-<?php echo $missions[$missions_j]['mission_id']; ?> mission-hover">
                <div class="wave"></div>
                <div class="stripes">
                    <div class="stripes-running"></div>
                </div>
                <img src="images/index/<?php missionImg(); ?>" alt="mission-<?php echo $missions_j; ?>">
                <div class="bg"></div>
