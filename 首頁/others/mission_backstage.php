            ...
            <div class="col-10">
                <table class="table table-striped">
                    <thead class="th thead-dark">
                        <tr>
                            <th scope="col" width="80" style="text-align:center">任務編號</th>
                            <th scope="col" width="160" style="text-align:center">任務代號</th>
                            <th scope="col" width="110" style="text-align:center">任務內容</th>
                            <th scope="col" width="110" style="text-align:center">建議攻擊值</th>
                            <th scope="col" width="500" style="text-align:center">建議防禦值</th>
                            <th scope="col" width="90" style="text-align:center">建議敏捷值</th>
                            <th scope="col" width="150" style="text-align:center">建議耐久值</th>
                            <th scope="col" width="100" style="text-align:center">建議隱匿值</th>
                        </tr>
                    </thead>
                    <tbody>
